...
CREATE TABLE SGJD_ADM_TAB_PARAMETRO_EDICION (
	...
	TamanoSubTitulo INT NOT NULL,
	TamanoTextoContenido INT NOT NULL,
	FuenteTitulo NVARCHAR (50) NOT NULL,
	FuenteSubTitulo NVARCHAR (50) NOT NULL,
	FuenteContenido NVARCHAR (50) NOT NULL,
	EstiloFuente NVARCHAR (20) NOT NULL,
	CONSTRAINT LLP_ParametroEdicion PRIMARY KEY CLUSTERED (LLP_Id ASC),
	CONSTRAINT LLF_ParametroEdicion_TipoObjeto_LLF_IdTipoObjeto FOREIGN KEY (LLP_IdLLF_IdTipoObjeto)
)
