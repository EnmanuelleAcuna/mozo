...
-- Proccedimiento almacenado para obtener todas las actas de acuersoft
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SGJD_ACT_PRO_ACTAS_ACUERSOFT]	
AS
BEGIN
...
EXEC [SGJD_ACT_PRO_ACTAS_ACUERSOFT]

GO

-- Proccedimiento almacenado para obtener todos los detalles de las actas de acuersoft
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SGJD_ACT_PRO_ACTAS_DETALLE_ACUERSOFT]	
	@idActa int
AS
BEGIN
...
EXEC SGJD_ACT_PRO_ACTAS_DETALLE_ACUERSOFT 1

GO

-- Procedimiento almacenado para buscar con una palabra clave en el encabezado y detalle de las actas de acuersoft
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SGJD_ACT_PRO_CONTAR_REGISTROS_PALABRA_CLAVE_ACTAS_ACUERSOFT]
	@Palabra NVARCHAR (250)
AS
BEGIN	
SELECT COUNT(Acta.LLP_Id)As Total, (COUNT(Acta.LLP_Id)/10)+1 as TotalPagina
	...
	WHERE	Acta.Numero_Acta LIKE '%' + @Palabra + '%' 
			OR Acta.Lugar LIKE '%' + @Palabra + '%' 
			OR Acta.Preside LIKE '%' + @Palabra + '%' 
			OR Acta.Secretario LIKE '%' + @Palabra + '%'
			OR Detalle.Numero_Acta LIKE '%' + @Palabra + '%'
			OR Detalle.Texto LIKE '%' + @Palabra + '%'
END

EXEC SGJD_ACT_PRO_CONTAR_REGISTROS_PALABRA_CLAVE_ACTAS_ACUERSOFT 'Lorem'
...
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SGJD_ACT_PRO_FILTRO_PALABRA_CLAVE_ACTAS_ACUERSOFT]
	@Palabra NVARCHAR (250),
	@Pagina INT
	
AS
BEGIN
	SELECT	Acta.LLP_Id AS IdActa, Acta.Numero_Acta AS NumeroActa, Acta.Fecha, Acta.Lugar,
			Acta.Preside, Acta.Secretario, Detalle.Texto AS Detalle					
	FROM	SGJD_ACT_TAB_ACTAS_ACUERSOFT Acta
	INNER JOIN SGJD_ACT_TAB_ACTAS_DETALLE_ACUERSOFT Detalle ON Detalle.LLF_IdActaAcuersoft = Acta.LLP_Id
	WHERE	Acta.Numero_Acta LIKE '%' + @Palabra + '%' 
			OR Acta.Lugar LIKE '%' + @Palabra + '%' 
			...
			OR Detalle.Numero_Acta LIKE '%' + @Palabra + '%'
			OR Detalle.Texto LIKE '%' + @Palabra + '%'
	ORDER BY Acta.LLP_Id
	OFFSET (@Pagina - 1) * 10 ROWS FETCH NEXT 10 ROWS ONLY;
END

EXEC SGJD_ACT_PRO_FILTRO_PALABRA_CLAVE_ACTAS_ACUERSOFT 'Lorem', 1

GO

-- Procedimiento almacenado para obtener la asistensia de los directores a las sesiones
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SGJD_ACT_PRO_OBTENER_INFORME_ASISTENCIA_SESION_DIRECTORES]
	@Usuario varchar(100),
	@Anno varchar(10) 
AS
BEGIN
...
EXEC SGJD_ACT_PRO_OBTENER_INFORME_ASISTENCIA_SESION_DIRECTORES 8, 2020

GO

-- Procedimiento almacenado para obtener la asistensia de los directores a las sesiones de forma detallado
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SGJD_ACT_PRO_OBTENER_INFORME_ASISTENCIA_SESION_DIRECTORES_DETALLADO]
	@Usuario varchar(100),
	@Anno varchar(10) 
AS
BEGIN
...
EXEC SGJD_ACT_PRO_OBTENER_INFORME_ASISTENCIA_SESION_DIRECTORES_DETALLADO 8, 2020

GO

-- Procedimiento almacenado para obtener las votaciones de los directores en los acuerdos
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SGJD_ACT_PRO_OBTENER_INFORME_VOTACIONES_ACUERDO_DIRECTORES]
	@Usuario varchar(100),
	@Anno varchar(10) 
AS
BEGIN
...
EXEC SGJD_ACT_PRO_OBTENER_INFORME_VOTACIONES_ACUERDO_DIRECTORES 8, 2020

GO

-- Procedimiento almacenado para obtener las votaciones de los directores en los acuerdos detallado
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[SGJD_ACT_PRO_OBTENER_INFORME_VOTACIONES_ACUERDO_DIRECTORES_DETALLADO]
	@Usuario varchar(100),
	@Anno varchar(10) 
AS
BEGIN
...
EXEC SGJD_ACT_PRO_OBTENER_INFORME_VOTACIONES_ACUERDO_DIRECTORES_DETALLADO 8, 2020
